"""
Django settings for chshare project.
...
SECRET_KEY = '9e3$!xw7r--akqzlupiy90u(cv@i*hxqqyvu-_ys+0u_$p(h(j'
...
WSGI_APPLICATION = 'chshare.wsgi.application'
